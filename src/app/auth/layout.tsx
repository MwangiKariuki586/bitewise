  ...
  return (
    <main className="grid min-h-dvh lg:grid-cols-[minmax(22rem,0.85fr)_minmax(30rem,1.15fr)]">
      <aside className="hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col xl:p-14">
        <Link href="/" className="flex w-fit items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground">
        ...
        <div className="my-auto max-w-lg py-14">
          ...
          <div className="mt-10 space-y-5">
            {benefits.map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-center gap-4 text-primary-foreground/82">
        ...
        <p className="text-sm text-primary-foreground/60">Made for real Kenyan kitchens.</p>
      </aside>
