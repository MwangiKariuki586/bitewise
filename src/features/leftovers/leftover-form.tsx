  ...
  return (
    <form action={action} className="space-y-4" noValidate>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-2"><Label htmlFor="preparedDate">Prepared</Label><DateInput id="preparedDate" name="preparedDate" defaultValue={item?.prepared_date ?? today} /><ErrorText errors={state.fieldErrors?.preparedDate} /></div>
        <div className="space-y-2"><Label htmlFor="expiryDate">Use by</Label><DateInput id="expiryDate" name="expiryDate" defaultValue={item?.expiry_date ?? today} /><ErrorText errors={state.fieldErrors?.expiryDate} /></div>
      </div>
