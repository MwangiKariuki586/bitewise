-- Eat Now accepts any non-negative whole-KES budget while preserving the
-- existing upper bound and bounded hard-constraint candidate pool.
...
as $$
  ...
  scaled as (
    ...
    where recipes.is_active
      ...
      and p_budget_minor between 0 and 100000000
